...
import Rattata from '../Img-pokemones/Rattata.png'
import Raticate from '../Img-pokemones/Raticate.png'
import Spearow from '../Img-pokemones/Spearow.png'
import Fearow from '../Img-pokemones/Fearow.png'
import Ekans from '../Img-pokemones/Ekans.png'
import Arbok from '../Img-pokemones/Arbok.png'
...
const informacion = [
...

    {
        ...
        height: 0.3,
        moves: ['Run Away', 'Guts'],
        description: 'Rattata is rat-like, with large incisors, a slight hump on its back towards the rear, a slightly pudgy belly, and a whisker on both sides.',
        stats: [30, 56, 35, 48, 48, 72],
    },

    {
        ...
        height: 0.7,
        moves: ['Run Away', 'Guts'],
        description: 'Compared to Rattata, Raticate is far more of a predator, and the majority of its features are adapted for this purpose',
        stats: [55, 81, 60, 58, 58, 97],
    },

    {
        ...
        weight: 2.0,
        height: 0.3,
        moves: ['Keen eyes', 'Sniper'],
        description: 'Spearow are an avian species of Pokémon characterized by its short stature, brown body, and pale red wings.',
...

    {
        ...
        height: 1.2,
        moves: ['Keen eyes', 'Sniper'],
        description: 'Fearow is a large, mostly brown bird Pokémon with a vulturine neck and broad, powerful wings',
...

    {
        ...
        weight: 6.9,
        height: 2.0,
        moves: ['Intimidate', 'Shed Skin'],
        description: 'Ekans is a snake-like Pokémon with purple and yellow coloring.',
...

    {
        ...
        height: 3.5,
        moves: ['Intimidate', 'Shed Skin'],
        description: 'Arbok bears a resemblance to a cobra, with the majority of its body being purple. ',
